...
public class InConThamAn extends AppCompatActivity {
    ...
    public void setWidget(){
        mediaPlayer = MediaPlayer.create(InConThamAn.this,R.raw.co_be_ban_diem_1);
        mediaPlayer.start();
    ...
    public void setEventOnComplete() {
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                mp = MediaPlayer.create(InConThamAn.this, listTruyen.get(currentIndex));
                mp.start();
                truyenPage();
            }
        });
    ...
    private void truyenPage() {
        if (currentIndex == 0) {
            page.setImageResource(R.drawable.in_1);
        }
        if (currentIndex == 1) {
            page.setImageResource(R.drawable.in_2);
        }
        if (currentIndex == 2) {
            page.setImageResource(R.drawable.in_3);
        }
        if (currentIndex == 3) {
            page.setImageResource(R.drawable.in_4);
        }
        if (currentIndex == 4) {
            page.setImageResource(R.drawable.in_5);
        }
        if (currentIndex == 5) {
            page.setImageResource(R.drawable.in_6);
        }
        if (currentIndex == 6) {
            page.setImageResource(R.drawable.in_7);
        }
        if (currentIndex == 7) {
            page.setImageResource(R.drawable.in_8);
        }
